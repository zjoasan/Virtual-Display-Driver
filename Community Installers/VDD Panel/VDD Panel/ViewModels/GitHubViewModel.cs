...
using VDD_Panel.Contracts.ViewModels;

namespace VDD_Panel.ViewModels;
...
public partial class GitHubViewModel : ObservableRecipient, INavigationAware
{
    // TODO: Set the default URL to display.
    [ObservableProperty]
    private Uri source = new("https://github.com/itsmikethetech/Virtual-Display-Driver");
    ...
    public GitHubViewModel(IWebViewService webViewService)
    {
